...
const IncreaseLiquidityModal: React.FC<IncreaseLiquidityModalProps> = ({ isOpen, onClose, position }) => {
  ...
  return (
    <ModalWrapper isOpen={isOpen} onClose={onClose} className="bg-gray-800 w-full max-w-md p-6">
      <div className="w-full">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-white">Increase Liquidity</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-gray-300 mb-2" htmlFor="token0Amount">
          ...
          <div className="mb-6">
            <label className="block text-gray-300 mb-2" htmlFor="token1Amount">
